  ...
  function ImageItem({ picture }) {
    return (
      <div className="pizza-block">
        ...
        <button onClick={() => removePicture(picture.id)}>Удалить товар из корзины</button>
        <img
        ...
        <div className="container">
          ...
          <div className="content__items">
            {picturesList ? (
              ...
              <h1>Корзина загружается или пустая</h1>
            )}
          </div>
          <button className="button1 button--outline button--add">
            <svg
              width="12"
              height="12"
              viewBox="0 0 12 12"
