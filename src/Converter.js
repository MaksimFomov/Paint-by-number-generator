      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div id="input-pane" class="col s12">
                ...
                <img id="imgTrivial" alt="Trivial" crossorigin="anonymous" src="https://i.imgur.com/o5CqO57.png"
                    style={{display: "none"}} />
                <img id="imgSmall" alt="Small" crossorigin="anonymous" src="https://i.imgur.com/YgYLDGP.png" style={{display: "none"}} />

                <img id="imgMedium" alt="Medium" crossorigin="anonymous" src="https://i.imgur.com/nLeNgYbr.jpg"
                    style={{display: "none"}} />
            </div>
...
/255,255,255
            ...
            <div class="col s12">
                <a1 class="waves-effect waves-light btn" id="btnProcess">Process image</a1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div id="output-pane" class="col s12">
                ...
                <div class="row">
                    <div class="col s3">
                        <a1 class="waves-effect waves-light btn" id="btnDownloadSVG">Download SVG</a1>
                    </div>
                    <div class="col s3">
                        <a1 class="waves-effect waves-light btn" id="btnDownloadPNG">Download PNG</a1>
                    </div>
                    <div class="col s3">
                        <a1 class="waves-effect waves-light btn" id="btnDownloadPalettePNG">Download palette</a1>
                    </div>
                </div>
            </div>
